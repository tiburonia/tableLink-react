  ...
  renderHTML(data) {
    ...
    return `
      ...
      <header class="mypage-top-header">
        ...
        <button class="settings-btn-icon" onclick="renderAccountSettings()"><img width="30" height="30" src="https://img.icons8.com/ios-filled/30/settings.png" alt="settings"/></button>
      </header>
