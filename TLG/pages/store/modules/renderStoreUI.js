    ...
    return `
      <div id="reviewPreview" class="review-preview modern-card">
        <div class="section-header">
          ...
          <button class="see-more-btn modern-text-btn" onclick="renderAllReview(window.currentStore)">
            <span>전체보기</span>
      ...
      <style>
        ...
        .review-preview.modern-card::before {
          content: '';
          position: absolute;
          top: 0;
          left: 0;
        ...
        .see-more-btn.modern-text-btn:hover {
        ...
        .review-card.modern-review:hover {
          transform: translateY(-1px);
