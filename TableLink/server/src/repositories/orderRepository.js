...
class OrderRepository {
  ...
  async createTicket(client, ticketData) {
    const { orderId, storeId, tableNumber, batchNo = 1, source, paidStatus = 'UNPAID' } = ticketData;
    ...
    const result = await client.query(`
      INSERT INTO order_tickets (
        ...
        created_at,
        paid_status
      ) VALUES ($1, $2, $3, 'PENDING', 'POSTPAID', $4, $5, NOW(), $6)
      RETURNING id
    `, [orderId, storeId, batchNo, source, tableNumber, paidStatus]);
